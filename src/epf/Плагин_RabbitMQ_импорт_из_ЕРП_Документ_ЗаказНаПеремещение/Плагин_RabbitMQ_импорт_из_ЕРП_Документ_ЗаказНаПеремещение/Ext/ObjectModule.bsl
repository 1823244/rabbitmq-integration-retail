...
Функция ЗагрузитьОбъект_ВДокумент(СтруктураОбъекта, jsonText = "") Экспорт
	...
	Если НЕ НРег(СтруктураОбъекта.type) = "документ.заказнаперемещение" Тогда
	...
	ОбъектДанных.ЗакрытВручную 		= ЛОЖЬ;
	...
	ОбъектДанных.МагазинПолучатель 	= РегистрыСведений.ксп_МэппингСкладМагазин.ПоМэппингу(деф.СкладОтправитель, мВнешняяСистема);
	ОбъектДанных.Организация 		= ксп_ИмпортСлужебный.НайтиОрганизацию(деф.Организация, мВнешняяСистема);
	ОбъектДанных.Ответственный 		= Неопределено;
	
	Если деф.Статус.Значение = "КОбеспечению" Тогда
		ОбъектДанных.Статус				= Перечисления.СтатусыВнутреннихЗаказов.КОбеспечению;
	ИначеЕсли деф.Статус.Значение = "КВыполнению" Тогда
		ОбъектДанных.Статус				= Перечисления.СтатусыВнутреннихЗаказов.КВыполнению;
	ИначеЕсли деф.Статус.Значение = "Закрыт" Тогда
		ОбъектДанных.Статус				= Перечисления.СтатусыВнутреннихЗаказов.Закрыт;
	КонецЕсли;
	...
	Для счТовары = 0 По деф.ТЧТовары.Количество()-1 Цикл
		...
		НовСтр.Количество 			= 0; //Возьмем из Расходного ордера на товары
		НовСтр.КоличествоУпаковок 	= 0; //Возьмем из Расходного ордера на товары
