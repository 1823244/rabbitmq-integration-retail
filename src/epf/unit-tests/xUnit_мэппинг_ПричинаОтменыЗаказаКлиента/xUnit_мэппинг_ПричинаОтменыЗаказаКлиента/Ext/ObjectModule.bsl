...
Процедура ПоМэппингу() Экспорт
	...
	ГУИД = "123";
	ВнешняяСистема = "ЕРП";
	РегистрыСведений.ксп_МэппингПричинаОтменыЗаказаКлиента.ПоМэппингу(ГУИД, ВнешняяСистема);

	РегистрыСведений.ксп_МэппингПричинаОтменыЗаказаКлиента.ДобавитьГУИД(ГУИД, "ТЕст", ВнешняяСистема);	
	
	Рез = РегистрыСведений.ксп_МэппингПричинаОтменыЗаказаКлиента.ПоМэппингу(ГУИД, ВнешняяСистема);
...
Процедура ЕстьГУИД() Экспорт
	...
	ГУИД = "123";
	ВнешняяСистема = "ЕРП";
	РегистрыСведений.ксп_МэппингПричинаОтменыЗаказаКлиента.ЕстьГУИД(ГУИД, ВнешняяСистема);

	РегистрыСведений.ксп_МэппингПричинаОтменыЗаказаКлиента.ДобавитьГУИД(ГУИД, "ТЕст", ВнешняяСистема);	
	
	Рез = РегистрыСведений.ксп_МэппингПричинаОтменыЗаказаКлиента.ЕстьГУИД(ГУИД, ВнешняяСистема);
