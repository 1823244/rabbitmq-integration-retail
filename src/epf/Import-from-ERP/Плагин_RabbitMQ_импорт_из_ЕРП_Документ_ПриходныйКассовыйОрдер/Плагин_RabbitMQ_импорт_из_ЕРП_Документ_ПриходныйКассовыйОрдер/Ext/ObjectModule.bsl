...
Функция КонвертацияХозОперации(Узел)
	...
	Если Рез = "ПоступлениеОплатыОтКлиента" Тогда
		_Опер = Перечисления.ХозяйственныеОперации.ПоступлениеОплатыОтКлиента;
		
	ИначеЕсли Рез = "ПоступлениеДенежныхСредствИзДругойОрганизации" Тогда
		_Опер = Перечисления.ХозяйственныеОперации.ПоступлениеДенежныхСредствИзДругойОрганизации
	...
	ИначеЕсли Рез = "ПоступлениеДенежныхСредствИзКассыККМ" Тогда
		_Опер = Перечисления.ХозяйственныеОперации.ПоступлениеДенежныхСредствИзКассыККМ
		
	ИначеЕсли Рез = "ПоступлениеДенежныхСредствИзДругойКассы" Тогда
		_Опер = Перечисления.ХозяйственныеОперации.ПоступлениеДенежныхСредствИзДругойКассы;
		
	ИначеЕсли Рез = "ПоступлениеДенежныхСредствИзБанка" Тогда
		_Опер = Перечисления.ХозяйственныеОперации.ПоступлениеДенежныхСредствИзБанка;
		
	ИначеЕсли Рез = "ИнкассацияДенежныхСредствИзБанка" Тогда
		_Опер = Перечисления.ХозяйственныеОперации.ПоступлениеДенежныхСредствИзБанка;
		
	ИначеЕсли Рез = "ПоступлениеДенежныхСредствПоКредитам" Тогда
		_Опер = Перечисления.ХозяйственныеОперации.ПрочиеДоходы;
		
	ИначеЕсли Рез = "ПоступлениеДенежныхСредствПоЗаймамВыданным" Тогда
		_Опер = Перечисления.ХозяйственныеОперации.ПрочиеДоходы;
		
	ИначеЕсли Рез = "ПрочееПоступлениеДенежныхСредств" Тогда
		_Опер = Перечисления.ХозяйственныеОперации.ПрочиеДоходы;
		
	ИначеЕсли Рез = "ВозвратДенежныхСредствОтПоставщика" Тогда
		_Опер = Перечисления.ХозяйственныеОперации.ВозвратДенежныхСредствОтПоставщика;
		
	ИначеЕсли Рез = "ВозвратДенежныхСредствОтПодотчетника" Тогда
		_Опер = Перечисления.ХозяйственныеОперации.ПрочиеДоходы;
		
	ИначеЕсли Рез = "ВозвратДенежныхСредствОтДругойОрганизации" Тогда
		_Опер = Перечисления.ХозяйственныеОперации.ПрочиеДоходы;
		
	ИначеЕсли Рез = "ВозвратДенежныхСредствОтАрендодателя" Тогда
		_Опер = Перечисления.ХозяйственныеОперации.ПрочиеДоходы;
	Иначе
		_Опер = Перечисления.ХозяйственныеОперации.ПрочиеДоходы;
	КонецЕсли;
