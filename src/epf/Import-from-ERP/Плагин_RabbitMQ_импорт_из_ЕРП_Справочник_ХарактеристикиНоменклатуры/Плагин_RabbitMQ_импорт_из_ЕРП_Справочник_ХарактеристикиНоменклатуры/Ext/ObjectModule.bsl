...
Функция ЗагрузитьОбъект(СтруктураОбъекта, jsonText = "") Экспорт
	...
	Если id.Owner.Свойство("type", type) Тогда   
		...
		ИначеЕсли type = "Справочник.ВидыНоменклатуры" Тогда
			Владелец = ксп_ИмпортСлужебный.НайтиВидНоменклатуры(id.Owner, мВнешняяСистема);
		КонецЕсли;
	КонецЕсли;
	

	Если не ЗначениеЗаполнено(Владелец) Тогда
		ВызватьИсключение "Не удалось найти владельца для Характеристики с гуидом "++", тип владельца: "+type;		
	КонецЕсли;
...
Процедура ЗаполнитьРеквизитыЭлемента(ОбъектДанных, def) Экспорт
	...
	ОбъектДанных.ВидНоменклатуры = РегистрыСведений.ксп_МэппингВидыНоменклатуры.ПоМэппингу(def.ВидНоменклатуры.ref, мВнешняяСистема);
