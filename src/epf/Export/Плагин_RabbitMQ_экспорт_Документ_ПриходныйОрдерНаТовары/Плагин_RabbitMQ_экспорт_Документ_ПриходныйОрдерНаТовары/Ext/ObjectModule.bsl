...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование","Плагин_RabbitMQ_экспорт_Документ_ПриходныйОрдерНаТовары");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	ПараметрыРегистрации.Вставить("Информация","Плагин_RabbitMQ_экспорт_Документ_ПриходныйОрдерНаТовары");
	...
	ДобавитьКоманду(ПараметрыРегистрации.Команды, 
		"Открыть форму : Плагин_RabbitMQ_экспорт_Документ_ПриходныйОрдерНаТовары",
		"Форма_Плагин_RabbitMQ_экспорт_Документ_ПриходныйОрдерНаТовары",
		ТипКоманды, 
		Ложь) ;
...
Функция ВыгрузитьОбъект(ДанныеСсылка) Экспорт
	Если ТипЗнч(ДанныеСсылка) = Тип("ДокументСсылка.ПриходныйОрдерНаТовары") Тогда
	...
	#Область ПодменаДокументаОснованияНаГУИДЗаказаНаПеремещение
	
	// НЕТИПОВОЕ!!! Связь с Заказом на перемещение для Элис
	//definition.Вставить("ДокументОснование", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(Обк.ДокументОснование));
	
	_перемещение = ДанныеСсылка.ДокументОснование;
	
	// найти перем в РС.ксп_ИсточникДанныхДляПеремещенийТоваровИзЕРП и взять ГУИД заказа
	
	гуид = РегистрыСведений.ксп_ИсточникДанныхДляПеремещенийТоваровИзЕРП.ГуидЗаказаПоПеремещению(_перемещение);
	
	СтруктураОснования = Новый Структура("type,ref,number,date",Неопределено,Неопределено,Неопределено,Неопределено);
	СтруктураОснования.type = "Документ.ЗаказНаПеремещение";
	СтруктураОснования.ref = гуид;
	СтруктураОснования.number = "";
	СтруктураОснования.date = "";
	definition.Вставить("ДокументОснование", СтруктураОснования);	
	
	#КонецОбласти	
	
	definition.Вставить("ДокументОснованиеПоступление", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(Обк.ДокументОснованиеПоступление));
