...
// -------------------------------------------- БЛОКИРОВКА   КОНЕЦ
		...
		КонецЕсли;
		ЭтоСправочник = Ложь;
		Если Справочники.ТипВсеСсылки().СодержитТип(_типОбъекта) Тогда
			ЭтоСправочник = Истина;
		КонецЕсли;
		ЭтоПВХ = Ложь;
		Если ПланыВидовХарактеристик.ТипВсеСсылки().СодержитТип(_типОбъекта) Тогда
			ЭтоПВХ = Истина;
		КонецЕсли;		
		...
		Попытка
			...
			Если ЭтоДокумент = Истина Тогда
				json = ксп_ЭкспортСлужебный.ВыгрузитьДокументПоСсылке(Объект);
			КонецЕсли;
			Если ЭтоСправочник = Истина Тогда
				json = ксп_ЭкспортСлужебный.ВыгрузитьСправочникПоСсылке(Объект);
			КонецЕсли;
			Если ЭтоПВХ = Истина Тогда
				json = ксп_ЭкспортСлужебный.ВыгрузитьПВХПоСсылке(Объект);
			КонецЕсли;
