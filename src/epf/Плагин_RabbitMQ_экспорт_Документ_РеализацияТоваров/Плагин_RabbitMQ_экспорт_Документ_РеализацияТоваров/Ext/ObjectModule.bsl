...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование","Плагин_RabbitMQ_экспорт_Документ_РеализацияТоваров");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	ПараметрыРегистрации.Вставить("Информация","Плагин_RabbitMQ_экспорт_Документ_РеализацияТоваров");
	...
	ДобавитьКоманду(ПараметрыРегистрации.Команды, 
		"Открыть форму : Плагин_RabbitMQ_экспорт_Документ_РеализацияТоваров",
		"Форма_Плагин_RabbitMQ_экспорт_Документ_РеализацияТоваров",
		ТипКоманды, 
		Ложь) ;
...
Функция ВыгрузитьОбъект(ДанныеСсылка) Экспорт
	Если ТипЗнч(ДанныеСсылка) = Тип("ДокументСсылка.РеализацияТоваров") Тогда
	...
	definition.Вставить("ДоверенностьДата", Обк.ДоверенностьДата);
	definition.Вставить("ДоверенностьНомер", Обк.ДоверенностьНомер);
	definition.Вставить("ДоверенностьЧерезКого", Обк.ДоверенностьЧерезКого);
	...
	definition.Вставить("УдалитьАдресЭП", Обк.УдалитьАдресЭП);
	definition.Вставить("УдалитьБанковскийСчетОрганизации", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(Обк.УдалитьБанковскийСчетОрганизации));
	definition.Вставить("УдалитьВидНалога", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(Обк.УдалитьВидНалога));
	definition.Вставить("УдалитьКассаККМ", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(Обк.УдалитьКассаККМ));
	definition.Вставить("УдалитьНомерЧекаККМ", Обк.УдалитьНомерЧекаККМ);
	definition.Вставить("УдалитьПодписьЧекаЕГАИС", Обк.УдалитьПодписьЧекаЕГАИС);
	definition.Вставить("УдалитьПробитЧек", Обк.УдалитьПробитЧек);
	definition.Вставить("УдалитьТелефон", Обк.УдалитьТелефон);
