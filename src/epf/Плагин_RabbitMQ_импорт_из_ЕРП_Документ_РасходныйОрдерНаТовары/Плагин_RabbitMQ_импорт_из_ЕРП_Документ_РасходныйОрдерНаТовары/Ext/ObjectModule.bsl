...
Функция ЗагрузитьОбъект_ВДокумент(СтруктураОбъекта, jsonText = "") Экспорт
	...
	СуществующийОбъект = Документы.РасходныйОрдерНаТовары.ПолучитьСсылку(Новый УникальныйИдентификатор(id.Ref));
...
Функция ЗагрузитьОбъект_ВРегистр(СтруктураОбъекта, jsonText = "") Экспорт
	...
	НЗ = РегистрыСведений.ксп_ИсточникДанныхДляПеремещенийТоваровИзЕРП
