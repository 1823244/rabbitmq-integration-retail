...
Функция ЗагрузитьОбъект(СтруктураОбъекта) Экспорт
	...
	СкладОтправитель = "";
	Если def.СкладОтправитель.Свойство("Ref", СкладОтправитель) Тогда
		ОбъектДанных.СкладОтправитель = Справочники.Склады.ПолучитьСсылку(Новый УникальныйИдентификатор(СкладОтправитель));
	КонецЕсли;
	СкладПолучатель = "";
	Если def.СкладПолучатель.Свойство("Ref", СкладПолучатель) Тогда
		ОбъектДанных.СкладПолучатель = Справочники.Склады.ПолучитьСсылку(Новый УникальныйИдентификатор(СкладПолучатель));
	КонецЕсли;
